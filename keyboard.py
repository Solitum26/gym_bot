...
list_of_mainmenu_2 = [mainmenu_train_inline, mainmenu_rewrite_inline, mainmenu_history_inline, mainmenu_help_inline]
...
dictionary_of_menu_inline = {'main_menu': main_menu_inline,
